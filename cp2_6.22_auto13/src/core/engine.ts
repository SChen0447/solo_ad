import type { GameState, Enemy, RenderData } from '../types';
...
import { updateAllPatrols } from '../modules/ai-patrol';
...
export class GameEngine {
  ...
  private updateEnemies(deltaTime: number): void {
    const { enemies } = updateAllPatrols(this.state.enemies, deltaTime);
    this.state.enemies = enemies;
  }
