...
export function seedData(): void {
  ...
  const seedTrees: Tree[] = [
    ...
    {
      id: 't7', name: '树苗七号', species: '', speciesColor: '',
      claimerId: null, claimerName: null, claimDate: null,
      x: 450, y: 280,
      growthRecords: [],
    },
    {
      id: 't8', name: '树苗八号', species: '', speciesColor: '',
      claimerId: null, claimerName: null, claimDate: null,
      x: -480, y: 300,
      growthRecords: [],
    },
    {
      id: 't9', name: '树苗九号', species: '', speciesColor: '',
      claimerId: null, claimerName: null, claimDate: null,
      x: 220, y: -450,
      growthRecords: [],
    },
    {
      id: 't10', name: '树苗十号', species: '', speciesColor: '',
      claimerId: null, claimerName: null, claimDate: null,
      x: -120, y: 480,
      growthRecords: [],
    },
    ...
    {
      id: 't13', name: '树苗十三号', species: '', speciesColor: '',
      claimerId: null, claimerName: null, claimDate: null,
      x: 50, y: -130,
      growthRecords: [],
    },
    {
      id: 't14', name: '树苗十四号', species: '', speciesColor: '',
      claimerId: null, claimerName: null, claimDate: null,
      x: -500, y: -30,
      growthRecords: [],
    },
