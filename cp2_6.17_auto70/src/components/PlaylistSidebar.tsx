...
function PlaylistSidebar({ favorites, onRemove, onReorder, themeColor }: PlaylistSidebarProps) {
  ...
  if (isMobile) {
    return (
      <>
        <style>{`
          .mobile-sidebar::-webkit-scrollbar { height: 4px; }
          .mobile-sidebar::-webkit-scrollbar-track { background: transparent; }
          .mobile-sidebar::-webkit-scrollbar-thumb { background: rgba(255,255,255,0.2); border-radius: 2px; }
        `}</style>
        <div
            ...
            return (
              <div
                ...
                style={{
                  ...
                  border: isOverTarget ? '2px dashed rgba(255,255,255,0.4)' : '2px solid transparent',
                  background: isOverTarget ? 'rgba(255,255,255,0.05)' : 'transparent',
